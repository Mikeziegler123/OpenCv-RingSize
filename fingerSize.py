...
# compute the rotated bounding box of the contour
	...
	# draw points at: top bottom left & right 
	# params: Image    Center_Coordinates   Radius  Color  Thickness
...
thresh = cv2.threshold(gray, 52, 255, cv2.THRESH_BINARY)[1]
...
imgroi = cv2.threshold(imgroi, 52, 255, cv2.THRESH_BINARY)[1]
